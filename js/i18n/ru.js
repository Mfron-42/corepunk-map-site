...
export default {
    ui: {
      ...
      // ЗАГОЛОВОК РАЗДЕЛА Мирной фауны (пул camp:wildlife), то же значение
      // «Мирная фауна», что у удалённой подписи subFaunePaisible.
      groupCreeps: 'Крипы',
      groupWildlife: 'Мирная фауна',
      ...
      //   2. 🟢 Позиции (goalPositions) — ОДНА ссылка: объединение точных
      //      размещений + пулов role="quest";
      //   3. 💡 Зоны обыскиваемых трупов (goalHintZonesTag) — ОДНА ссылка:
      //      объединение пулов role="generic", семейство 💡, как «Мирные животные»;
      ...
      // Две объединённые метки позиций (каждая рисует объединение своих точек
      // одним кликом): 🟢 данные (размещения + пулы задания), 💡 выведенные по
      // луту зоны (покрывают карту, одна метка).
