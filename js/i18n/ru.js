...
export default {
    ui: {
      ...
      //   2. Рекомендуемые места (goalSuggestedPositionsLabel) — лёгкая подсказка 💡:
      //      Зоны спавна трупов (goalHintZonesTag), объединение квестового и общих
      //      пулов, рисуемая ПОДСКАЗКА; нюанс (goalHintZonesNote) во всплывающей.
      ...
      // Лёгкая подсказка 💡: префикс «Рекомендуемые места:» + концепт зон спавна
      // (goalHintZonesTag) + нюанс, свёрнутый во всплывающую подсказку.
      goalSuggestedPositionsLabel: 'Рекомендуемые места:',
      goalHintZonesTag: 'Зоны спавна трупов',
