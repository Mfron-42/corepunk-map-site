...
export default {
    ui: {
      ...
      // Дерево слоёв (#82, этап (a),  unified_layers_DESIGN.md
      // §2/§11/§12(a)): 6 фиксированных групп боковой панели заменяют
      // "Легенда"/"Лагеря и ресурсы" выше (ключи оставлены, но больше не
      // используются ни одним data-i18n -- см. index.html) + будущий слот
      // "Закреплённые фильтры" (#82, этап (d), пока только структурный,
      // всегда скрыт). GLOSSARY-PENDING: дизайн-документ фиксирует только
      // французский текст (мокап §2) -- эти RU-строки являются прямым
      // переводом до прохода извлечения глоссария (#86, см.
      // COORDINATION.md); проверить здесь, когда он будет готов.
      groupPoi: 'Точки интереса',
      groupMonsters: 'Монстры и фауна',
