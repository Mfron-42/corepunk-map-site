...
export default {
    ui: {
      ...
      // Дерево шарів (#82, зріз (a),  unified_layers_DESIGN.md
      // §2/§11/§12(a)): 6 фіксованих груп бічної панелі замінюють
      // "Легенда"/"Табори та ресурси" вище (ключі залишені, але більше не
      // використовуються жодним data-i18n -- див. index.html) + майбутній
      // слот "Закріплені фільтри" (#82, зріз (d), поки що лише структурний,
      // завжди прихований). GLOSSARY-PENDING: дизайн-документ фіксує лише
      // французький текст (макет §2) -- ці UK-рядки є прямим перекладом до
      // проходу вилучення глосарія (#86, див. COORDINATION.md); звірити тут,
      // коли він буде готовий.
      groupPoi: 'Точки інтересу',
      groupMonsters: 'Монстри та фауна',
