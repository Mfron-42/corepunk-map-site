...
export default {
    ui: {
      ...
      //   2. Рекомендовані місця (goalSuggestedPositionsLabel) — легка підказка 💡:
      //      Зони спавну трупів (goalHintZonesTag), об'єднання квестового та
      //      загальних пулів, мальована ПІДКАЗКА; нюанс (goalHintZonesNote) у спливній.
      ...
      // Легка підказка 💡: префікс «Рекомендовані місця:» + концепт зон спавну
      // (goalHintZonesTag) + нюанс, згорнутий у спливну підказку.
      goalSuggestedPositionsLabel: 'Рекомендовані місця:',
      goalHintZonesTag: 'Зони спавну трупів',
