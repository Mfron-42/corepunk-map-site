...
export default {
    ui: {
      ...
      // Розміщені (фіксовані) трупи + агрегат зон пошуку
      // (goalSpawnPoolAggregate) — одна лінія на всі пули спавну, деталі у
      // згорнутій шухляді. Підсумок — сума даних по пулах.
      goalCorpsePlacedN: n => `${n} розміщених трупів`,
      goalSpawnAggLabel: 'Зони пошуку — трупи (спавн)',
      goalSpawnAggMeta: (pts, zones) => `${pts} т. · ${zones} зон`,
      goalSpawnAggRoles: (q, g) =>
        q && g ? `зокрема ${q} зон завдання + ${g} доведених загальних зон`
          : q ? `${q} зон завдання`
