...
export default {
    ui: {
      ...
      // РОЗДІЛУ Мирної фауни (пул camp:wildlife), те саме значення «Мирна фауна»,
      // що й у видаленого підпису subFaunePaisible.
      groupCreeps: 'Кріпи',
      groupWildlife: 'Мирна фауна',
      ...
      //   2. 🟢 Позиції (goalPositions) — ОДНЕ посилання: об'єднання точних
      //      розміщень + пулів role="quest";
      //   3. 💡 Зони обшукуваних трупів (goalHintZonesTag) — ОДНЕ посилання:
      //      об'єднання пулів role="generic", родина 💡, як «Мирні тварини»;
      ...
      // Дві об'єднані мітки позицій (кожна малює об'єднання своїх точок одним
      // кліком): 🟢 дані (розміщення + пули завдання), 💡 виведені за лутом зони
      // (покривають карту, одна мітка).
